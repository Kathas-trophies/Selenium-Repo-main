...
class TestLoginPopup(unittest.TestCase):
    ...
    def test_un_popup(self):
        ...
        #Assertions
        self.assertTrue(popup.is_displayed(), "Login did not display popup message")
        self.assertIn("success", popup_message.lower(), f"Login did not display popup message {popup_message}")
        time.sleep(3)
